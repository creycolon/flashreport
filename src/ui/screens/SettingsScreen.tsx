...
import { View, StyleSheet, ScrollView, SafeAreaView, Alert, Platform, Switch, TouchableOpacity } from 'react-native';
import { useRouter } from 'expo-router';
import { theme } from '../theme';
import { Typography, Card, Button } from '../components';
import { testDataService } from '../../application/services/testDataService';
