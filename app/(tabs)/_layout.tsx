...
import { View, Text, StyleSheet, Platform, useWindowDimensions, TouchableOpacity, SafeAreaView } from 'react-native';
    ...
    if (isWebDesktop) {
        ...
        switch (activeScreen) {
            case 'dashboard':
                ...
                break;
            case 'list':
                ScreenComponent = MovementsListScreen;
                break;
            case 'add':
                ScreenComponent = AddMovementScreen;
                break;
            case 'reports':
                ScreenComponent = ReportsScreen;
                break;
            case 'settings':
